...
import { projects } from './ProjectsPage'; // Importamos los datos de los proyectos
...
const ProjectDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      // Si encontramos el proyecto, buscamos proyectos relacionados por categoría
      if (foundProject) {
  ...
  if (!project) {
    return (
      <div className="min-h-screen flex flex-col justify-center items-center container-main py-20">
        <h1 className="text-3xl font-gilroy font-medium text-text-primary mb-4">Proyecto no encontrado</h1>
        ...
        <div className="container-main">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-8">
              ...
              >
                <div>
                  <h2 className="font-gilroy font-medium text-3xl text-text-primary mb-6">
                    Visión general
                  </h2>
                  ...
                  <p className="text-text-secondary">
                    Este proyecto demuestra capacidades en arquitectura escalable, optimización de rendimiento y diseño centrado en el usuario, resolviendo problemas reales con soluciones técnicas innovadoras.
                  </p>
                </div>
