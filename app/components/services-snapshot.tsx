...
function ServiceCard({ service, index, isInView }: ServiceCardProps) {
  return (
    ...
    >
      ...
      <h3 className="font-space-grotesk font-bold text-xl text-text-primary mb-3">{service.title}</h3>
      <p className="font-standerd text-text-secondary mb-6 flex-grow">{service.description}</p>
      <Link
        href={service.link}
        className="inline-flex items-center font-space-grotesk font-medium text-lime-neon hover:underline mt-auto"
      >
        Saber más
...
export default function ServicesSnapshot() {
  ...
  return (
    <section ref={ref} className="py-16 md:py-24 bg-background" aria-label="Services snapshot section">
      <div className="container-main">
        ...
        >
          <h2 className="font-space-grotesk font-bold text-4xl md:text-5xl mb-4 text-text-primary">Servicios</h2>
